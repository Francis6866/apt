      ...
      <nav className='w-2/3 absolute right-0 h-screen bg-white'>
            ...
            <ul className=' bg-white'>
                <li className='py-5 px-6 border-b-[0.5px] border-b-[#ccc]'>
                    <NavLink onClick={() => setShowMobile(false)} to='/' className={({isActive}) => isActive ? 'text-[#3D081B] text-2xl opacity-100' : 'opacity-50 block py-4'}>HOME</NavLink>
                </li>
                <li 
                    className='py-5 px-6 border-b-[0.5px] border-b-[#ccc] flex justify-between items-center relative'
                    onClick={()=>setShowDrop(!showdrop)}
                >
                    <NavLink className='opacity-50 block py-4'>ABOUT US</NavLink>
                    ...
                    {
                        showdrop && <DropNav setShowMobile={setShowMobile}/>
                    }
                <li className='py-5 px-6 border-b-[0.5px] border-b-[#ccc]'>
                    <NavLink onClick={() => setShowMobile(false)} to='/contact' className={({isActive}) => isActive ? 'text-[#3D081B] text-2xl opacity-100' : 'opacity-50 block py-4'}>CONTACTS</NavLink>
                </li>
                <li className='py-5 px-6 border-b-[0.5px] border-b-[#ccc]'>
                    <NavLink onClick={() => setShowMobile(false)} to='/gallery' className={({isActive}) => isActive ? 'text-[#3D081B] text-2xl opacity-100' : 'opacity-50 block py-4'}>GALLERY</NavLink>
                </li>
            </ul>
        </nav>
    </div>
